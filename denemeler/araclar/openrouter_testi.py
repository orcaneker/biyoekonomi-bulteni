...
def test_yetenek(gecit):
    ...
    dolgu = ("Biyoekonomi bülteni triyaj sistem bloğu için dolgu metni; "
...
# ============================================================
SAHTE_ADAYLAR = [
    {"id": "t1", "title": "Novozymes announces new enzyme plant in Denmark",
     "domain": "reuters.com", "published_date": "2026-09-18",
     "snippet": ("Danish enzyme maker announced a 300 million euro investment "
                 "in a new industrial enzyme production facility in Kalundborg, "
                 "expected to start operations in 2028 with 200 employees.")},
    {"id": "t2", "title": "EU approves updated bioeconomy strategy",
     "domain": "ec.europa.eu", "published_date": "2026-09-17",
     "snippet": ("The European Commission adopted the revised EU Bioeconomy "
                 "Strategy, setting a target to double the share of bio-based "
                 "materials in industrial feedstock by 2035.")},
    {"id": "t3", "title": "Celebrity chef opens vegan restaurant in Paris",
     "domain": "example-magazine.com", "published_date": "2026-09-16",
     "snippet": ("A well known chef opened a plant-based restaurant; the menu "
                 "features seasonal vegetables.")},   # REDDEDİLMELİ
]
...
# ============================================================
SAHTE_DERIN = [{
    "event_key": "ab-biyoekonomi-strateji-2026",
    "kategori": "politika",
    "puan": 88,
    "olgunluk": "karar",
    "baslik_ozet": "AB güncellenmiş Biyoekonomi Stratejisini kabul etti",
    "sirketler": [],
    "ulkeler": ["AB"],
    "kaynaklar": [{
        "name": "European Commission", "domain": "ec.europa.eu",
        "url": "https://ec.europa.eu/example-bioeconomy-strategy",
        "published_date": "2026-09-17", "primary": True, "paywall": False,
        "text": ("The European Commission adopted the revised EU Bioeconomy "
                 "Strategy on 17 September 2026. The strategy sets a target to "
                 "double the share of bio-based materials in industrial "
                 "feedstock to 20 percent by 2035, allocates 1.2 billion euro "
                 "from Horizon Europe to biomanufacturing pilot lines, and "
                 "introduces a single market framework for bio-based product "
                 "labelling. Member states must submit national bioeconomy "
                 "action plans by the end of 2027. The Commission estimates the "
                 "sector currently employs 17 million people in the EU and "
                 "generates 2.4 trillion euro in annual turnover."),
    }],
}]

SAHTE_RADAR = [
    {"event_key": "novozymes-kalundborg", "kategori": "biyomanufaktur",
     "baslik_ozet": "Novozymes Danimarka'da yeni enzim tesisi açıklaması",
     "kaynaklar": [{"name": "Reuters", "domain": "reuters.com",
                    "url": "https://reuters.com/example-novozymes",
                    "published_date": "2026-09-18", "primary": True}]},
    {"event_key": "brezilya-etanol-hedefi", "kategori": "biyoyakit",
     "baslik_ozet": "Brezilya 2030 etanol harmanlama hedefini yükseltti",
     "kaynaklar": [{"name": "Bloomberg", "domain": "bloomberg.com",
                    "url": "https://bloomberg.com/example-etanol",
...
def test_yazim(model):
    ...
    sonuc("story id = event_key", "ab-biyoekonomi-strateji-2026" in idler,
