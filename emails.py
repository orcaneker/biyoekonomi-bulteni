# -*- coding: utf-8 -*-
"""
BİYOEKONOMİ BÜLTENİ — E-POSTALAR (Resend)
=============================================
Dört e-posta türü:
...
MAIL_FROM = os.environ.get("MAIL_FROM", "Biyoekonomi Bülteni <onboarding@resend.dev>")
...
def _sablon(ust, baslik, govde_html):
    return (f"<!doctype html><html><head><meta charset='utf-8'>"
            ...
            f"<div class='kucuk'>Biyoekonomi Bülteni — otomatik bildirim. "
...
def davet_gonder(hakem, link, sayi_no, hafta, lead_baslik, haber_sayisi):
    ...
    html = _sablon(
        ...
        f"<p>Bu haftanın biyoekonomi bülteni taslağı hazırlandı: "
    ...
    return _gonder(hakem["email"], f"[İnceleme] Biyoekonomi Bülteni — Sayı {sayi_no} taslağı hazır", html)
...
def yayinlandi_gonder(alicilar, sayi_no, hafta, site_url, onaylayan):
    ...
    return _gonder(alicilar, f"Biyoekonomi Bülteni — Sayı {sayi_no} yayında", html)
