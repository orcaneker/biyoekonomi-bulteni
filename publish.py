# -*- coding: utf-8 -*-
"""
BİYOEKONOMİ BÜLTENİ — YAYIN (CRON 2 — Pazartesi 08:00 TSİ)
==============================================================
Akış:
...
def nihai_kur(taslak):
    ...
    # --- metrikler ---
    # ⚠ Biyoekonomide kapasite birimleri heterojendir (ton/yıl, milyon litre,
...
def ses_metni(bulten):
    ...
    satirlar = [
        f"Biyoekonomi Bülteni. {d.day} {AY_TR[d.month - 1]} {d.year}, sayı {i['number']}.",
...
<rss version="2.0"><channel>
  <title>Biyoekonomi Bülteni</title>
  <link>{SITE_URL}</link>
  <description>Haftalık biyoekonomi sektörü ve politika izleme bülteni</description>
...
def main():
    ...
    t0 = time.time()
    log("═" * 46)
    log(f"BİYOEKONOMİ BÜLTENİ — YAYIN — "
