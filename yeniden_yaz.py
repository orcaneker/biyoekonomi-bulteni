# -*- coding: utf-8 -*-
"""
BİYOEKONOMİ BÜLTENİ — YAZIMI YENİDEN ÇALIŞTIR (model kıyası)
=================================================================
...
def main():
    ...
    if args.kontrol:
        for k in ("EXA_API_KEY", "OPENROUTER_API_KEY", "OPENAI_API_KEY",
            ...
            # hanesi. İki makinede anahtar gerçekten aynı mı diye bakmanın
            # güvenli yolu: izler eşitse anahtar birebir aynıdır, farklıysa
            # kopyalama hatası vardır. "Bende çalışıyor ama onda 401 veriyor"
            # vakalarının neredeyse tamamı budur — eksik karakter, satır sonu,
            # tırnak, görünmez boşluk. İzi karşı tarafa yazmak güvenlidir;
            # özetten anahtar geri üretilemez.
