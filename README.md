...
Haftalık otomatik biyoekonomi sektörü, teknoloji ve politika izleme bülteni —
...
Eski Perplexity + Netlify tabanlı sistemin yerini alan yeni mimari:
arama motoru **Exa AI**, triyaj **Claude Haiku 4.5**, yazım **Claude Sonnet 4.6**,
...
sistem-prompt-biyoekonomi.md   Sistemin beyni/referans belgesi
```

## Kurulum

### 1. GitHub deposu
Bu depo `orcaneker/biyoekonomi-bulteni`.
GitHub → Settings → Pages → Source: **main / docs** seçin.
Site adresi: `https://orcaneker.github.io/biyoekonomi-bulteni`
...
| `GITHUB_REPO` | ✅ (cron 2 + web) | `orcaneker/biyoekonomi-bulteni` |
| `GITHUB_TOKEN` | ✅ (cron 2 + web) | PAT — Contents: Read & Write |
| `REVIEW_BASE_URL` | ✅ (cron 1-2) | inceleme servisinin URL'i (ör. `https://biyoekonomi-bulten-inceleme.onrender.com`) |
| `RAPOR_ALICI` | — | çalışma raporu e-postası (ör. orcaneker@gmail.com) |
...
- **Hero videosu**: bir tanıtım videosunu `assets/video/hero.webm`
  (yedek: `assets/img/hero.jpg`) olarak koyun — site otomatik gösterir.
  Hedef: ≤1.5 MB, 6-8 sn, sessiz.
