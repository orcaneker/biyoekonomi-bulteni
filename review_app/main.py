# -*- coding: utf-8 -*-
"""
BİYOEKONOMİ BÜLTENİ — İNCELEME SERVİSİ (Render Web Service)
===============================================================
...
app = FastAPI(title="Biyoekonomi Bülteni — İnceleme", docs_url=None, redoc_url=None)
...
@app.get("/")
def saglik():
    return {"servis": "biyoekonomi-bulten-inceleme", "durum": "ok"}
